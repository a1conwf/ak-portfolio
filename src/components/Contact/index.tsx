	...
	const sendEmail = (data: emailSchemaValues) => {
		...
		emailjs
			...
			.catch((error) => {
				...
				toast.error("Something went wrong while sending an email, please try again later!");
			});
	};
	...
	return (
		<section className="contact" id="contact">
			<div className="container">
				<div className="contact__inner" data-aos="fade-up" data-aos-delay="100">
					<div className="contact__info">
						<h2 className="contact__info-title">Contact</h2>
						<p className="contact__info-text">
							Got a question or proposal, or just want to say hello? Go ahead. I'll try my best to
							get back to you!
						</p>
					</div>
					...
					<form className="form" onSubmit={handleSubmit(onSubmit)} autoComplete="off">
						...
						<div className={`form__group ${errors.message && "error"}`}>
							...
							/>
							<img src={iconError} alt="icon-error" className="form__group-icon" />
							<span className="form__group-error">{errors.message?.message}</span>
						</div>
